...
#define SIDECAR_POWER_READ_REG_START 0x0160
#define SIDECAR_POWER_READ_REG_END 0x016F
#define SIDECAR_POWER_READ_REG_NUM (SIDECAR_POWER_READ_REG_END - SIDECAR_POWER_READ_REG_START + 1)

#define FANS_SYS_SET_REG_START 0x0120
#define FANS_SYS_SET_REG_END 0x012F
#define FANS_SYS_SET_TOTAL_NUM (FANS_SYS_SET_REG_END - FANS_SYS_SET_REG_START + 1)

#define FANS_SYS_DISP_REG_START 0x0130
#define FANS_SYS_DISP_REG_END 0x013F
#define FANS_SYS_DISP_TOTAL_NUM (FANS_SYS_DISP_REG_END - FANS_SYS_DISP_REG_START + 1)

#define FANS_FG_PWM_SET_REG_START 0x0140
#define FANS_FG_PWM_SET_REG_END 0x015F
